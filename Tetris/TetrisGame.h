...
public:
	...
	static const double MAX_LEVELS;
...
private:	
	...
	int cleared;				// the amount of rows cleared on the current level
	bool gameOver;
	...
	GridTetromino ghostShape;	// the ghost shape for where the current shape will land
	...
	sf::Font levelFont;				// SFML font for displaying the level.
	sf::Text levelText;				// SFML text object for displaying the level

	sf::Font gameOverFont;				// SFML font for displaying the game over text.
	sf::Text gameOverText;				// SFML text object for displaying the game over text
		
	// Sound members ---------------------------------------------
	sf::SoundBuffer dropBuffer;		//SFML sound buffer for the drop sound effect 
	sf::Sound dropSound;			//SFML sound object for the drop sound effect

	sf::SoundBuffer rotateBuffer;	//SFML sound buffer for the rotate sound effect 
	sf::Sound rotateSound;			//SFML sound object for the rotate sound effect

	sf::SoundBuffer levelUpBuffer;	//SFML sound buffer for the level up sound effect 
	sf::Sound levelUp;				//SFML sound object for the level up sound effect

	sf::SoundBuffer gameOverBuffer;	//SFML sound buffer for the game over sound effect 
	sf::Sound gameOverSound;		//SFML sound object for the game over sound effect

	sf::SoundBuffer musicBuffer;	//SFML sound buffer for the background music sound effect 
	sf::Sound music;				//SFML sound object for the background music sound effect

	sf::SoundBuffer clearedBuffer;		//SFML sound buffer for the cleared sound effect 
	sf::Sound clearedSound;			//SFML sound object for the cleared sound effect
...
public:
	...
	// getter for the gameOver member variable
	// - params: none
	// - return: bool representing current state of the game
...
private:
	...
	// return: nothing
	void drawBlock(const Point &topLeft, int xOffset, int yOffset, const TetColor &color, int transparency);
	...
	// return: nothing
	void drawTetromino(GridTetromino &tetromino, Point topLeft, int transparency);
	
	// update the score display
	// form a string "score: ##" to display the current score
	// use scoreText.setString() to display it.
	// params: none:
	// return: nothing
	...
	// use levelText.setString() to display it.
	// params: none:
	// return: nothing
